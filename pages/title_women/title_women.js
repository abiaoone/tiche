...
Page({
  ...
  data: {
    ...
    maxTitleCount: 10,
    propress: 0,
    title: ['您手脚发凉吗？', '您胃脘部、背部或腰膝部怕冷吗？', '您感到怕冷、衣服比别人穿得多吗？', '您比别人容易患感冒吗？', '您感觉身体、脸上发热吗？', '您口唇的颜色比一般人红吗？', '您容易便秘或大便干燥吗？', '您面部两颧潮红或偏红吗？', '您感到眼睛干涩吗？', '您容易疲乏吗?', '您容易心慌吗？', '您容易头晕或站起时晕眩吗？', '您比别人容易患感冒吗？', '您喜欢安静、懒得说话吗？', '您感到胸闷或腹部胀满吗?', '您腹部肥满松软吗？', '您有额部油脂分泌多的现象吗？', '您嘴里有黏黏的感觉吗？', '您活动量稍在太容易出虚汗吗？', '您容易感到害怕或受到惊吓吗？', '您胁肋部或乳房胀痛吗？', '您无缘无故叹气吗', '您咽喉部有异物感, 且吐之不出、咽之不下吗？', '您两颧部有细微红丝吗？', '您身体上哪里疼痛吗？', '您容易忘事(健忘)吗', '您口唇颜色偏黯吗？', '您没有感冒时也会打喷嚏吗?', '您没有感冒时也会鼻塞、流鼻涕吗？', '您有因季节变化、温度变化或异味等原因而咳喘的现象吗？', '您的皮肤一抓就红，并出现抓痕吗？', '您精力充沛吗?', '您容易疲乏吗？', '您说话声音低弱无力吗？', '您容易失眠吗？', '您容易忘事 (健忘)吗？', '您面部或鼻部有油腻感或者油亮发光吗?', '您小便明尿道有发热感、尿色浓(深)吗？', '您带下色黄 (白带颜色发黄)吗？ (限女性回答)']
  },
  ...
  tijiao: function (e) {
    ...
    if (index == 41) {
      wx.navigateTo({
        url: '../result/result?maxIndex=' + this.data.maxIndex + '&sex=women'
      })
    }
    that.setData({
      index: index,
